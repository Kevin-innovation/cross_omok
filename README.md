...
### 향후 계획
- 🔲 구글 로그인 기능
- 🔲 로그인 하면, 승률 승 / 무 / 패 계산하여 퍼센테이지로 리더보드 만들기(게임 통계 및 전적 / 랭킹시스템)
- 🔲 칭호 시스템 개발 -> 승률 별 / ai 승리 수 별.. 등등 다양한 30개 이상의 칭호 개발 후 리더보드 / 프로필에 띄울수 있게 기능 추가
- 🔲 Ai 와 대전 시 / 연습 모드일 지 / 랭킹 모드일지 -> 랭킹모드라면 프로필 리더보드에 승률 누적 / 연습모드라면 무르기 버튼 추가. (30초 시간제한 제거)
- 🔲 프로필에 연승 띄우기 (Ai 대전 2연승 중 ... or 랭킹모드(인간vs인간) 대전 2연승 중... 이런식으로)
